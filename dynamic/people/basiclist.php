...
$page=new Page("people/basiclist.php","People");
...
<?PHP echo $page->drawMilestone(); ?>
            ...
            <div class="span10">
                  ...
                  <table class="table" border="0" cellspacing="0" cellpadding="0">
					...
					if(isset($_GET['page'])) $pc->loadActivePeoplePage((int)$_GET['page']);
					else $pc->loadActivePeoplePage(1);
					...
					foreach($pc->entities as $entity){
						...
						if(!(isset($entity->raw->centres)&&(int)$entity->raw->centres>0)) $flags.=' <span class="label">Unassigned</span>';
						...
						if(!isset($entity->guardianconfirm)||(int)$entity->guardianconfirm==0) $flags.=' <a href="confirmguardian.php?person='.$entity->id.'" class="label label-warning">No guardian</a>';
						if(!isset($entity->telno)||strlen($entity->telno)<5) $flags.=' <a href="edit.php?person='.$entity->id.'" class="label label-important">No telephone</a>';
						if(!isset($entity->latlng)||strlen($entity->latlng)<5) $flags.=' <a href="edit.php?person='.$entity->id.'" class="label label-important">No geo</a>';
						
						if(isset($entity->notes)&&strlen($entity->notes)>3) $flags.=' <a href="edit.php?person='.$entity->id.'" class="label label-info">Notes</a>';
