...
$page=new Page("mentors/basiclist.php","Mentors");
...
<?PHP echo $page->drawMilestone(); ?>
            ...
            <div class="span10">
                  ...
                  <table class="table" border="0" cellspacing="0" cellpadding="0">
					...
					if(isset($_GET['page'])) $pc->loadActiveMentorsPage((int)$_GET['page']);
					else $pc->loadActiveMentorsPage(1);
					...
					foreach($pc->entities as $entity){
						...
						if(!isset($entity->telno)||strlen($entity->telno)<5) $flags.=' <a href="edit.php?mentor='.$entity->id.'" class="label label-important">No telephone</a>';
						if(!isset($entity->latlng)||strlen($entity->latlng)<5) $flags.=' <a href="edit.php?mentor='.$entity->id.'" class="label label-important">No geo</a>';
						
						if(isset($entity->notes)&&strlen($entity->notes)>3) $flags.=' <a href="edit.php?mentor='.$entity->id.'" class="label label-info">Notes</a>';
						
						
						echo '<tr>
                        <th scope="row"><a href="edit.php?mentor='.$entity->id.'">'.$entity->name.'</a></th>
