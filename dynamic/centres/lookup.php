            ...
            <div class="span10">
                ...
                <form class="well form-search" method="get" action="?">
                    ...
                    <select id="field" name="field">
                        ...
                        <option<?PHP echo (isset($_GET['field'])&&$_GET['field']=='telno')?' selected="selected"':'' ?> value="contacttel">Telephone (excl. +44)</option>
                    </select> &nbsp;
                  ...
                  <table class="table" border="0" cellspacing="0" cellpadding="0">
					...
					foreach($pc->entities as $entity){
                        ...
                        <td><a href="../centres/edit.php?centre='.$entity->id.'" class="btn btn-mini btn-primary">Edit</a>
						<a href="../mentors/edit.php?mentor='.$entity->contactmentor.'" class="btn btn-mini">View / Edit Contact</a> </td>
                      </tr>';
					}
